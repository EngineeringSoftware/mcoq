package edu.utexas.ece.mcoq_toolpaper.location;
...
import static edu.utexas.ece.mcoq_toolpaper.mutation.Mutation.SEXP_VALID_VERNAC_TYPES;
...
public class MutationLocation {
    ...
    public List<MutationLocation> findAll(Sexp sExp, Mutation mutation, boolean allVernacTypes) {
        ...
        final Sexp subSExp = sExp.get(TWO).get(ONE);
        if (!subSExp.isAtomic()) {
